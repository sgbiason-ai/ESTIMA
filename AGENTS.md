...
- [x] **Pages de garde** : choix global entre modèle Estima et « CARTOUCHE PAPYRUS STANDARD » pour les exports PDF, Word et Excel existants
...
| V | Date | Changes |
|---|------|---------|
| 2.6 | Juillet 2026 | **Pages de garde** : ajout du modèle global « CARTOUCHE PAPYRUS STANDARD » inspiré du cartouche DCE, avec adaptation automatique des identités MOA/MOE, logos et champs projet sur les exports PDF, Word et Excel existants |
