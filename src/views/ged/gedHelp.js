    ...
    // ─── Onglet : Comparer (audit) ──────────────────────────────────────
    {
      ...
      sections: [
        ...
        },
        {
          ...
          rows: [
            { label: 'Synthèse', desc: 'Écart total HT + cascade « décomposition de l\'écart » (ajouts, suppressions, effet quantité, effet prix)' },
            { label: 'Chapitres', desc: 'Comparaison du montant de chaque chapitre, avec l\'écart' },
            { label: 'Articles', desc: 'Détail trié par impact : pour chaque ligne, effet quantité et effet prix séparés' },
          ],
        },
        {
          type: 'card',
          icon: 'BarChart3',
          color: 'indigo',
          title: 'Effet quantité vs effet prix',
          description: 'Chaque article modifié décompose son écart : la part due au changement de quantité et la part due au changement de prix unitaire. La somme des deux = l\'écart total de la ligne.',
          tip: 'Idéal pour expliquer un avenant : « +X € de quantités, +Y € de révision de prix ».',
        },
        {
          type: 'card',
          icon: 'FileDown',
          ...
          description: 'Bouton « Exporter » en haut : génère le comparatif en PDF ou Excel (synthèse, décomposition, articles modifiés) à joindre au client comme justificatif d\'évolution entre deux indices.',
        },
        {
          type: 'tip',
          title: 'Recherche, tri & tranches',
          text: 'Les articles modifiés sont triés par impact décroissant ; une barre de recherche filtre par désignation. Si l\'affaire a des tranches, un sélecteur compare tranche par tranche.',
        },
      ],
    },
