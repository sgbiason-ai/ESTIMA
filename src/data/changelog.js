...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      'Compte Rendu de chantier : aide à la relecture des observations. Une suggestion discrète signale les fautes récurrentes (ex. « diffuera » → « diffusera », « tramsettra » → « transmettra »), les mots collés (« MARCOULYindique »), la ponctuation répétée (« !! »), les passages tout en majuscules et les espaces en trop — sans rien corriger automatiquement ni bloquer la saisie',
