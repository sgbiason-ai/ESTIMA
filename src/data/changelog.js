...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      'Estimation : chaque PSE peut désormais recevoir une description / justification. Sous l\'en-tête d\'une PSE (chapitre ou sous-chapitre), un champ repliable « Description PSE » permet d\'expliquer clairement la prestation en texte riche (gras, souligné, listes à puces). Le texte est persisté par projet et repris dans les exports : page PSE dédiée du PDF (encadré sous le titre), bloc PSE de l\'Excel, et sous la ligne de la PSE dans le récapitulatif financier. À ce stade, les puces et la mise en forme en liste sont conservées dans les exports ; le gras/souligné reste visible à l\'écran et dans l\'aperçu',
