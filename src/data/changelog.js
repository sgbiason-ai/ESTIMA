...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      'Bibliothèque (Blocs) : liste des blocs élargie et plus lisible — le prix unitaire s\'affiche en pastille (avec l\'unité du bloc en dessous). Nouveau filtre par unité (menu déroulant) et tri par nom, unité ou prix (clic pour inverser croissant / décroissant) ; le compteur indique « blocs filtrés / total »',
