...
export const CHANGELOG = [
  {
    ...
    highlights: [
      'Visites de site — nouveau mode « Annotation » : des plans (PDF ou image) peuvent être joints à une visite et annotés d’épingles numérotées reliées aux observations. L’import d’un PDF propose le choix des pages, chaque page devenant un plan nommable stocké en image haute résolution ; la visionneuse permet zoom, déplacement et pose d’épingles au doigt comme à la souris — chaque épingle crée une nouvelle observation ou se lie à une existante, dont elle reprend le numéro. Sur tablette, un troisième onglet « Annotation » rejoint Observations et Terrain ; sur ordinateur, le volet carte gagne un sélecteur Carte / Plans. Le rapport PDF ajoute une page « Plan annoté » par plan (orientée portrait ou paysage selon le plan), avec ses épingles numérotées renvoyant aux fiches d’observations ; la fenêtre d’export permet de les exclure',
      'Visites de site — sur une visite partagée en lecture seule, le mode Annotation passe en consultation pure : les plans et leurs épingles restent consultables (zoom, déplacement, « Ouvrir » une observation depuis son épingle), mais l’import de plan, l’ajout, le déplacement et le retrait d’épingles, le renommage et la suppression de plans sont masqués au lieu d’échouer en silence',
      'Visites de site — « Nettoyer la trace » (retrait des pics, lissage de la courbe) ne s’applique désormais qu’une seule fois par trace : le bouton se verrouille ensuite (« Nettoyée »), pour éviter qu’un nettoyage répété ne rabote peu à peu le tracé jusqu’à ne plus en laisser grand-chose. Annuler le nettoyage ou enregistrer de nouveaux points GPS le réactive',
      'Visites de site — rapport PDF : les fiches d’observations sont recomposées à raison de deux observations par page, séparées à mi-hauteur. Les photos s’organisent en rangées centrées — trois de front pour les verticales, deux pour les horizontales — et se redimensionnent pour tenir dans leur demi-page ; une observation de plus de deux photos, ou au texte très long, occupe une page entière avec ses photos en grand format. Les vignettes « Satellite + Plan » passent en deux bandeaux superposés pleine largeur, nettement plus lisibles que les deux carrés côte à côte',
      ...
      'Comptes Rendus, plan d’actions — les observations s’affichent avec leur mise en forme (gras, souligné, surlignage, listes à puces), au lieu du texte brut mêlé de balises. Le statut de chaque action se change directement depuis le plan, sans ouvrir l’affaire : un menu propose Vide / Ouvert / En cours / FAIT, et solder une action la retire aussitôt de l’échéancier. Les actions d’un chantier créé par quelqu’un d’autre restent en lecture seule. Le plan s’ouvre désormais en plein écran',
      ...
      'Version mobile — chaque export propose désormais deux actions fiables et distinctes : télécharger le fichier ou ouvrir le partage natif. Les PDF Analyse, RAO, page de garde et lettre de négociation ainsi que les classeurs BPU, DQE et Analyse Excel sont tous pris en charge ; annuler le partage ne déclenche plus de téléchargement inattendu',
      'Version mobile — les exports Analyse, RAO et lettre de négociation reprennent désormais les données réellement enregistrées : formule et barème de notation, consultation, critères, tranche RAO, PSE retenues, classements avant/après négociation et comparatif final. Les rapports mobiles ne retombent plus silencieusement sur la formule F1/40 ni sur des champs de consultation vides',
      'Comptes Rendus — un chantier achevé peut désormais être « terminé » : il quitte la liste des affaires en cours et rejoint un onglet « Terminées » du sélecteur d’affaires. Un bouton « Terminer » dans le ruban récapitule le nombre de comptes rendus et signale les observations non soldées du dernier CR avant confirmation. L’affaire terminée reste entièrement consultable et exportable (PDF, Word) mais passe en lecture seule, avec un bandeau indiquant la date de clôture et un bouton « Réactiver » ; rien n’est supprimé et l’opération est réversible à tout moment. Sur tablette, les chantiers terminés sont masqués par défaut de la liste terrain et regroupés sous le même onglet',
      'Documents administratifs — toutes les vues gagnent en lisibilité et en densité : en-tête et liste des marchés resserrés, badge des fiches liées à EstimaVRD, navigation unique entre Synthèse, Fiche marché et documents EXE, rubans EXE moins hauts et zones de travail mieux exploitées. La fiche marché est désormais organisée en quatre onglets métier (MOA, Marché, Titulaire/Attributaires et MOE), avec champs plus compacts, contrastes renforcés et suppression des effets lumineux, afin de limiter fortement le défilement sans réduire la taille utile du texte',
      'Documents administratifs — les fiches marché peuvent désormais être créées depuis une affaire EstimaVRD ou liées après leur création. Les champs compatibles de la modale « Fiche affaire » sont repris (MOA, MOE, objet, référence, lieu, préparation, durée et lot), la liaison à l’affaire source reste visible et une actualisation manuelle présente chaque valeur avant/après sans toucher au titulaire, à la notification ni aux autres saisies administratives',
      'Documents administratifs — export PDF des réserves EXE4 / EXE5 entièrement restructuré : choix mémorisé entre un mode Détaillé (par défaut) et Compact, page de repérage GPS avec statistiques, tableau de synthèse paginé, fiches numérotées avec mini-plan local et photos adaptatives, ou planches photographiques condensées. Les références photo Rxx-Pxx, les coordonnées GPS cliquables, les images indisponibles signalées et la pagination propre à l’annexe rendent le document exploitable à l’écran comme sur chantier',
