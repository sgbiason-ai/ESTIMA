...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      'RAO (export PDF) — vous choisissez désormais d\'afficher ou non les références aux prix anormalement bas (OAB). Lorsqu\'au moins une offre anormalement basse est détectée, la fenêtre de vérification avant export propose une case « Inclure les références aux prix anormalement bas (OAB) » (décochée par défaut). Cochée, le PDF signale l\'OAB comme avant (surlignage du détail des prix, encadré nominatif du récapitulatif et annexe « Méthode OAB ») ; décochée, aucune mention d\'OAB n\'apparaît dans le rapport',
      'RAO (export PDF) — la même fenêtre de vérification avant export propose désormais une case « Inclure les annexes » (cochée par défaut) pour ajouter ou retirer l\'Annexe B (formules de notation du critère prix) et l\'Annexe C (références du Code de la commande publique), afin de produire au besoin un rapport allégé',
