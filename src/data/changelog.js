...
export const CHANGELOG = [
  {
    ...
    highlights: [
      'Bibliothèque : nouveaux « blocs » (ouvrages composites) — regroupez plusieurs articles sous un même nom et une unité (ex. « Voirie légère en granulaire » au m²). Pour chaque composant, renseignez son épaisseur et sa densité : le prix est automatiquement ramené à l\'unité du bloc (ex. 54,35 €/m²). Géré via l\'onglet « Blocs » de la Bibliothèque (recherche d\'articles accent-insensible). Dans l\'estimation, une zone « Blocs » (en bas du volet bibliothèque, recherchable) permet d\'insérer un bloc en un clic : il s\'ajoute comme un sous-chapitre portant la surface (Qté + unité, saisie sur l\'en-tête, par tranche), et chaque composant reçoit une quantité calculée automatiquement (= surface × épaisseur × densité). Le bloc reste transparent pour le bordereau : pas de numéro, jamais compté comme un article, juste un titre de regroupement à l\'export. Son en-tête affiche le PU moyen (€ / unité du bloc) et peut être basculé en PSE / option comme un sous-chapitre',
