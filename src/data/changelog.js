...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      'RAO, import d’une offre entreprise — correction : un article dont l’entreprise a retouché la désignation pouvait être rattaché au mauvais prix, et le bon article rester à 0 €. Le repli sur le numéro de prix se laissait devancer par la numérotation automatique, décalée dès qu’un prix est réutilisé dans plusieurs sous-chapitres — un « P.43 » automatique occupait la place du véritable article P.43. Les numéros réellement saisis sont désormais prioritaires',
