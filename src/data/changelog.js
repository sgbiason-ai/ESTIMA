...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      'Gestion de Projets — barre d\'outils repensée : l\'ancien ruban à largeurs fixes (qui débordait de l\'écran sur les petites largeurs) est remplacé par une barre fluide qui s\'adapte à la place disponible — le nom de l\'affaire se tronque proprement, les libellés se replient en icônes quand la fenêtre rétrécit, plus aucun débordement. Le bouton « Sauvegarder » devient le bouton principal (bleu plein, avec ses états Sauvegarde… / Sauvegardé), les commandes de fichier (Importer un projet, Exporter une copie, Dupliquer la session) sont regroupées dans un menu « Fichier », et la date de dernière sauvegarde s\'affiche en relatif (« Sauvegardé il y a 8 min »). Les tuiles gagnent un bouton « Ouvrir » noir toujours visible et un menu « ⋯ » pour les autres actions. Les fenêtres Aide, Déplacer et l\'historique local adoptent enfin le thème clair du reste de l\'application',
