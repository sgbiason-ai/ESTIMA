...
export const CHANGELOG = [
  {
    ...
    highlights: [
      'Visites de site (mobile) — la mesure de segments arrive sur mobile, à parité avec l\'ordinateur : depuis une visite, appuyez sur « Départ » pour poser le point de départ GPS, marchez jusqu\'à l\'arrivée puis « Fin » — la distance PAR LA ROUTE est calculée automatiquement (itinéraire IGN, repli en « vol d\'oiseau » si le réseau manque), avec une estimation d\'incertitude. Un bouton « Point » enregistre un simple repère GPS. Les boutons sont accessibles depuis les onglets « Observations » et « Terrain », le segment créé s\'ajoute à la liste des observations et son tracé apparaît sur la carte',
