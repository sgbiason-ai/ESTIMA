...
export const CHANGELOG = [
  {
    ...
    highlights: [
      'Visites de site — « Nettoyer la trace » ne lisse plus le tracé : l’action retire uniquement les points aberrants (imprécis, sauts de vitesse, pointes isolées) sans déplacer les points conservés, là où l’ancien lissage rabotait les virages. Le nettoyage ne s’applique désormais qu’une seule fois par trace — le bouton se verrouille ensuite (« Nettoyée ») ; annuler le nettoyage ou enregistrer de nouveaux points GPS le réactive. Le lissage complet reste appliqué automatiquement à l’arrêt de l’enregistrement, sur la trace brute',
