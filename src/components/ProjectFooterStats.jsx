...
const ProjectFooterStats = ({
  ...
  // ── Mode simple : une colonne — total « à valoir » (rendu) quel que soit le mode ──
  const baseTotal = projectStats?.client?.base ?? totalBase;
  return (
    <div className="flex justify-end mt-8 mb-20">
      <div className="bg-white rounded-2xl border border-gray-200/60 p-6 w-96">
          <div className="flex justify-between items-center mb-1">
            ...
            <span className={`text-sm font-black font-mono ${theme.textMain}`}>{formatPrice(baseTotal)}</span>
          </div>
