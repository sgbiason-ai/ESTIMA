        ...
        <div className="grid grid-cols-[24px_48px_100px_1fr_72px_48px_100px_24px] xl:grid-cols-[30px_80px_120px_1fr_86px_80px_120px_30px] gap-x-2 items-center">
          ...
          <div className="flex flex-col gap-1 min-w-0">
            ...
            <div
              ...
              className={`w-full text-sm leading-relaxed [@media(pointer:coarse)]:text-[16px] [@media(pointer:coarse)]:leading-relaxed px-2 py-1.5 [@media(pointer:coarse)]:px-3 [@media(pointer:coarse)]:py-2.5 border border-slate-200 rounded focus:outline-none focus:ring-1 focus:ring-emerald-400 min-h-[34px] [@media(pointer:coarse)]:min-h-[44px] text-slate-800 whitespace-pre-wrap select-text empty:before:content-[attr(data-placeholder)] empty:before:text-slate-300 ${isEditing ? 'max-h-[40vh] overflow-y-auto' : ''}`}
              style={{
                outline: 'none',
