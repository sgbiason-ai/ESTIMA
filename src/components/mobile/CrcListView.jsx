    ...
    <div className="pb-2">
      <div className="flex gap-2 px-4 pt-3 pb-2 mb-1">
        <div className="flex-1 bg-white rounded-xl p-3 border border-gray-200/60 text-center">
          <div className="text-xl font-bold text-gray-900">{chantiers.length}</div>
          <div className="text-[13px] text-gray-400 font-medium">Chantiers</div>
        </div>
        <div className="flex-1 bg-white rounded-xl p-3 border border-gray-200/60 text-center">
          <div className="text-xl font-bold text-gray-900">{chantiers.reduce((s, c) => s + c.meetingCount, 0)}</div>
          <div className="text-[13px] text-gray-400 font-medium">Réunions</div>
        </div>
